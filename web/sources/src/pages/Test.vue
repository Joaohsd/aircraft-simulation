        ...
        <v-container class="text-center">
            <v-form ref="form" v-model="valid" lazy-validation>
                <v-container class="text-center">
                    ...
                    <v-text-field v-model="name" :rules="nameRules" label="Tempo do Ensaio" required>
                    </v-text-field>

                    <v-select v-model="select" :items="items" :rules="[v => !!v || 'Item is required']" label="Engenheiro Resposável"
                        required>
                    </v-select>
